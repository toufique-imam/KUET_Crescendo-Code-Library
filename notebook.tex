...
\lstdefinestyle{shared}{
    ...
    basicstyle=\fontsize{7.5}{6}\ttfamily,
}
\lstdefinestyle{cpp}{
	style=shared,
    language=C++,
...
\pagestyle{fancy}
\fancyhead[L]{\texttt{KUET\_Crescendo}}
\fancyhead[R]{\thepage}
\fancyfoot[C]{}
...
\title{\vspace{-4ex}\Large{\texttt{\textbf{K\color{red}UET\_Crescendo Notebook (2019-20)}}}}
\author{\texttt{RUDRA\_DAS | Joker\_pablo | sabertooth}}
\date{  }
